...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $query = $pdo->prepare("select products.*, categories.name as'category name' from products inner join categories on products.c_id = categories.id where products.id = :id");
